...
<body style="background-color: rgb(172, 83, 83); padding-top:8%;">
        ...
        <div class="container" style="padding:10px 80px 10px 80px; margin-top:2%;">
            ...
            <div class="container"
                ...
                <form action="contact_us.php" method="post" autocomplete="off">
                    ...
                    <br><br><input class="btn mybtn btn-outline-light" type="submit" value="Submit" style="background-color: black">
                </form>
            </div>
        </div>
